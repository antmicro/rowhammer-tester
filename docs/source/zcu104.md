...
```{note}
You only need to export `IP_ADDRESS` if you want to use a different address than the default one (see the [Network setup](zcu104.md#network-setup) section).
```
