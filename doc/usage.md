...
Currently, 4 boards are supported, each targetting different memory type:
...
For board-specific instructons refer to [Arty A7](arty.md), [ZCU104](zcu104.md), [DDR4 Datacenter DRAM Tester](ddr4_datacenter_dram_tester.md) and [LPDDR4 Test Board](lpddr4_tb.md) chapters.
